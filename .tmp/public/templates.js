...
angular.module("contact/index.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("contact/index.tpl.html",
    ...
    "                  <div class=\"front contact-one\">design</div>\n" +
    "                  <div class=\"back\">Our creative team's first and most important step is understanding who you are. Once we're sure that's achieved, there are no limits. From logos and print-work to fully formed brands, NOVO translates skill and experience into striking visuals that embody your core.<br> Design is in our DNA.</div>\n" +
    "                </div>\n" +
    "              </div>\n" +
    "            </div>\n" +
    "            <div class=\"col-md-4 contact-col\">\n" +
    ...
    "                  <div class=\"front contact-two\">development</div>\n" +
    "                  <div class=\"back\">Building websites with powerful, reliable, and modern technology is a given. Beyond that, user experience is the focus. Each click should lead an audience on a journey through your vision. <br>Tell your story with elements that seamlessly flow into each other.<br> Mobile-ready. Universally compatibale.</div>\n" +
    "                </div>\n" +
    "              </div>\n" +
    "            </div>\n" +
    "            <div class=\"col-md-4 contact-col\">\n" +
    ...
    "                  <div class=\"front contact-three\">marketing</div>\n" +
    "                  <div class=\"back\">Extend your influence through comprehensive and efficient strategies. Our clients, on average, see a 500% increase in social media and domain traffic. Our marketing team is composed of experts in fields ranging from data science to content creation. Tell us where you want to go.<br> We'll tell you how to get there.</div>\n" +
    "                </div>\n" +
    "              </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
...
angular.module("home/about.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("home/about.tpl.html",
    ...
    "  <div class=\"about-topping\">\n" +
    "    <div class=\"about-title\">\n" +
    "      <p>The <img style=\"height:60px\" src=\"/images/novo/logo-w.png\"> Experience</p>\n" +
    "    </div>\n" +
    "    <div class=\"about-desc\">\n" +
    "      <p>\n" +
    "        Crafting an effective message is about delivering the right words in a way that&nbsp;will&nbsp;be&nbsp;remembered.\n" +
